  ...
  const load = async () => {
    ...
    try {
      const [overviewRes, plansRes] = await Promise.all([
        getQaAiCoachingOverview(),
        getQaAiAgentPlans({ status: statusFilter, risk: riskFilter, search }),
      ]);
  ...
  return (
    ...
    >
      <motion.header className={classes.header} variants={presets.child}>
        ...
        <div>
          <h2>QA AI Coaching Visibility</h2>
...
export default QaAITrainingPage;
